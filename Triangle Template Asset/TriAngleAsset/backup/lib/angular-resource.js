 ...
 *   - **`cache`** â€“ `{boolean|Cache}` â€“ A boolean value or object created with
 ...
 *   - **`withCredentials`** â€“ `{boolean}` â€“ Whether to set the `withCredentials` flag on the
 *     XHR object. See
 *     [XMLHttpRequest.withCredentials](https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest/withCredentials)
 *     for more information.
 *   - **`responseType`** â€“ `{string}` â€“ See
 *     [XMLHttpRequest.responseType](https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest/responseType).
 *   - **`interceptor`** â€“ `{Object=}` â€“ The interceptor object has four optional methods -
 ...
 *   - **`hasBody`** â€“ `{boolean}` â€“ If true, then the request will have a body.

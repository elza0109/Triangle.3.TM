...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	<div class="row"><div class="col-lg-12">
		<WebPartPages:WebPartZone runat="server" Title="header" ID="header"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone></div>
	</div>

    <div class="row">
        <div class="col-lg-3">
			<WebPartPages:WebPartZone runat="server" Title="Zone 1" ID="LeftColumn"  Orientation="Vertical"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone></div>
        <div class="col-lg-9">

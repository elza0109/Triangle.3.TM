...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	<div class="row">
    	<div class="col-lg-12">
			<WebPartPages:WebPartZone runat="server" Title="Content" ID="Content"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
		</div>
		 <div class="col-lg-6">
			<WebPartPages:WebPartZone runat="server" Title="Zone Left" ID="TopLeftRow"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone></div>
        <div class="col-lg-6">
			<WebPartPages:WebPartZone runat="server" Title="Zone Right" ID="TopRightRow"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone></div>
	</div>
</asp:Content>
